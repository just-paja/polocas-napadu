import { Entity, TeamEntity } from './generics'
...
export const getContestantTypeBySide = (side: ContestantSide): ContestantType => {
...
export const getContestantBySide = (contestants: ContestantGroup[], side: ContestantSide) => {
